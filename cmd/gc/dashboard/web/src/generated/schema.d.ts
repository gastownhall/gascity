...
export interface components {
    schemas: {
        ...
        SessionRecoveredPayload: {
            /** @description Free-form recovery action taken, e.g. "nudge-continue", "wake-then-nudge", or "nudge-compact". Diagnostic only. */
            action?: string;
            /** @description Free-form recovery reason, e.g. "rate_limit" or "context_frozen". Never a role name. */
            reason?: string;
            /** @description Canonical session bead ID of the recovered session, when the emitter knows it. The event envelope's Subject carries the same id. */
            session_id?: string;
        };
        ...
        TypedEventStreamEnvelopeSessionRecovered: {
            actor: string;
            message?: string;
            payload: components["schemas"]["SessionRecoveredPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
