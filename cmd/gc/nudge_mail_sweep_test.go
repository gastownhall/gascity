...
func TestSweepStaleNudgeMail_TTLBoundaries(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeTTL, mailTTL, 0)
	if err != nil {
...
func TestSweepStaleNudgeMail_PendingExclusion(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, state, now, nudgeTTL, time.Hour, 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.NudgeClosed != 1 {
...
func TestSweepStaleNudgeMail_OpenStatusFilter(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, time.Minute, mailTTL, 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.MailClosed != 1 {
...
func TestSweepStaleNudgeMail_BudgetCap(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeTTL, mailTTL, budget)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestSweepStaleNudgeMail_PerBeadCloseFailureContinues(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeTTL, time.Hour, 0)
...
func TestSweepStaleNudgeMail_BudgetSplitNudgeThenMail(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeTTL, mailTTL, 3)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if result.NudgeClosed != 2 {
...
func TestCountStaleNudgeMail_ListErrorPropagates(t *testing.T) {
	...
	_, err := countStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeMailSweepDefaultNudgeTTL, nudgeMailSweepDefaultMailTTL, 0)
	if err == nil {
...
func TestRunNudgeMailSweepWatchdog_ClosesStaleBeads(t *testing.T) {
	...
	result, err := sweepStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeMailSweepDefaultNudgeTTL, nudgeMailSweepDefaultMailTTL, nudgeMailSweepWatchdogCloseBudget)
	if err != nil {
...
func TestCountStaleNudgeMail_MatchesSweepCounts(t *testing.T) {
	...
	counts, err := countStaleNudgeMail(beads.NudgesStore{Store: store}, store, nil, now, nudgeTTL, mailTTL, 0)
	if err != nil {
