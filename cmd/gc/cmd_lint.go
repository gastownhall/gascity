...
func lintPromptContext(packDir string, agentCfg config.Agent, providers map[string]config.ProviderSpec) PromptContext {
	...
	return PromptContext{
		...
		Branch:                  "feature/lint",
		DefaultBranch:           "main",
		AssignedInProgressQuery: agentCfg.EffectiveAssignedInProgressQuery(),
		AssignedReadyQuery:      agentCfg.EffectiveAssignedReadyQuery(),
		RoutedPoolQuery:         agentCfg.EffectiveRoutedPoolQuery(),
