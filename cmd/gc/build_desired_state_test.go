...
func TestDefaultScaleCheckDemandCarriesTriggerBeadID(t *testing.T) {
	...
	counts, demand, _, errs := defaultScaleCheckCountsAndDemand(nil, time.Now(), []defaultScaleCheckTarget{{
		template: template,
		storeKey: "rig:gascity",
		store:    store,
	}})
...
func TestDefaultScaleCheckCountsAndDemandNormalizesInstanceSuffixedRouteTarget(t *testing.T) {
	...
	counts, demand, partialTemplates, errs := defaultScaleCheckCountsAndDemand(cfg, time.Now(), []defaultScaleCheckTarget{{
		template: template,
...
func TestDefaultScaleCheckCountsAndDemandLeavesUnmatchedInstanceSuffixAlone(t *testing.T) {
	...
	counts, _, _, errs := defaultScaleCheckCountsAndDemand(cfg, time.Now(), []defaultScaleCheckTarget{{
		template: template,
		storeKey: "rig:hello-world",
		store:    store,
	}})
