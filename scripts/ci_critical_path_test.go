...
func TestAcceptanceTargetsSeparateTierAFromExternalBdContracts(t *testing.T) {
	...
	wantTests := []string{"TestBdBasicCRUD", "TestBdClaimLease", "TestBdDependencies", "TestBdDestructive", "TestBdWorkflow"}
	...
	for _, marker := range []string{
		...
		"-count=1",
		"-run '^(TestBdBasicCRUD|TestBdClaimLease|TestBdDependencies|TestBdDestructive|TestBdWorkflow)$$'",
		"./test/acceptance",
	} {
