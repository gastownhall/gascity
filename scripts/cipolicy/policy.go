...
const (
	...
	// Bumped for the cmd-gc-process failure-diagnostics upload: the shard now
	// advertises GC_TEST_FAILURE_ARTIFACT_DIR and uploads that directory on
	// failure, so a red shard carries the bd proxy child's log instead of only
	// the one sentence that names it.
	expectedCIExecutionHash      = "40ac346428e1731a6562ad3ab0820582a2a0514c8f30a8466f5a91f72f4370e0"
