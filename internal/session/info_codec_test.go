...
func infoFromPersistedBeadFrozen(b beads.Bead) Info {
	...
	info := Info{
		...
		ExecutionClaimNudgeStalled:                b.Metadata[ExecutionClaimNudgeStalledMetadataKey],
		ProviderSessionKeyReceiptToken:            b.Metadata[ProviderSessionKeyReceiptTokenMetadataKey],
		ProviderSessionKeyReceiptAuthority:        b.Metadata[ProviderSessionKeyReceiptAuthorityMetadataKey],
		ProviderSessionKeyReceiptConsumeAuthority: b.Metadata[ProviderSessionKeyReceiptConsumeAuthorityMetadataKey],
		ProviderSessionKeyReceiptIssuedAt:         b.Metadata[ProviderSessionKeyReceiptIssuedAtMetadataKey],
		SessionHookActivityGate:                   b.Metadata[SessionHookActivityGateMetadataKey],
		...
		WakeRequestToken:               b.Metadata["wake_request_token"],
