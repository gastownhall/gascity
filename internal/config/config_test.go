...
func TestEffectiveWorkQueryDefault(t *testing.T) {
	...
	if !strings.Contains(got, `bd ready --metadata-field "gc.routed_to=$target" --unassigned --exclude-type=epic --exclude-type=message --exclude-label "hold:mayor" --exclude-label "hold:external" --json --sort oldest --limit=20`) {
	...
	if !strings.Contains(got, `bd ready --metadata-field "gc.run_target=$target" --metadata-field "gc.kind=workflow" --unassigned --exclude-type=epic --exclude-type=message --exclude-label "hold:mayor" --exclude-label "hold:external" --json --sort oldest --limit=20`) {
...
func TestEffectiveWorkQueryBD105CompatibilityOptIn(t *testing.T) {
	...
	if !strings.Contains(got, `bd ready --include-ephemeral --metadata-field "gc.routed_to=$target" --unassigned --exclude-type=epic --exclude-type=message --exclude-label "hold:mayor" --exclude-label "hold:external" --json --sort oldest --limit=20`) {
...
set -eu
case "$*" in
  "ready --metadata-field gc.routed_to=hello-world/worker --unassigned --exclude-type=epic --exclude-type=message --exclude-label hold:mayor --exclude-label hold:external --json --sort oldest --limit=20")
...
func TestEffectiveWorkQueryExcludesEpics(t *testing.T) {
	...
	wantPresent := []string{
		...
		`bd ready --metadata-field "gc.routed_to=$target" --unassigned --exclude-type=epic --exclude-type=message --exclude-label "hold:mayor" --exclude-label "hold:external" --json`,
