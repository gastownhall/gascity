...
/**
 * Get v0 city by city name agent by base suspension
 */
export const getV0CityByCityNameAgentByBaseSuspension = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByBaseSuspensionData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByBaseSuspensionResponses, GetV0CityByCityNameAgentByBaseSuspensionErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{base}/suspension', ...options });

/**
 * Put v0 city by city name agent by base suspension
 */
export const putV0CityByCityNameAgentByBaseSuspension = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentByBaseSuspensionData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentByBaseSuspensionResponses, PutV0CityByCityNameAgentByBaseSuspensionErrors, ThrowOnError>({
...
/**
 * Get v0 city by city name agent by dir by base suspension
 */
export const getV0CityByCityNameAgentByDirByBaseSuspension = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByDirByBaseSuspensionData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByDirByBaseSuspensionResponses, GetV0CityByCityNameAgentByDirByBaseSuspensionErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{dir}/{base}/suspension', ...options });

/**
 * Put v0 city by city name agent by dir by base suspension
 */
export const putV0CityByCityNameAgentByDirByBaseSuspension = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentByDirByBaseSuspensionData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentByDirByBaseSuspensionResponses, PutV0CityByCityNameAgentByDirByBaseSuspensionErrors, ThrowOnError>({
