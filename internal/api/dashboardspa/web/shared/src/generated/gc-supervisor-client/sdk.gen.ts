...
/**
 * Get v0 city by city name agent suspension by base
 */
export const getV0CityByCityNameAgentSuspensionByBase = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentSuspensionByBaseData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentSuspensionByBaseResponses, GetV0CityByCityNameAgentSuspensionByBaseErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent-suspension/{base}', ...options });

/**
 * Put v0 city by city name agent suspension by base
 */
export const putV0CityByCityNameAgentSuspensionByBase = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentSuspensionByBaseData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentSuspensionByBaseResponses, PutV0CityByCityNameAgentSuspensionByBaseErrors, ThrowOnError>({
    url: '/v0/city/{cityName}/agent-suspension/{base}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Get v0 city by city name agent suspension by dir by base
 */
export const getV0CityByCityNameAgentSuspensionByDirByBase = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentSuspensionByDirByBaseData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentSuspensionByDirByBaseResponses, GetV0CityByCityNameAgentSuspensionByDirByBaseErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent-suspension/{dir}/{base}', ...options });

/**
 * Put v0 city by city name agent suspension by dir by base
 */
export const putV0CityByCityNameAgentSuspensionByDirByBase = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentSuspensionByDirByBaseData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentSuspensionByDirByBaseResponses, PutV0CityByCityNameAgentSuspensionByDirByBaseErrors, ThrowOnError>({
    url: '/v0/city/{cityName}/agent-suspension/{dir}/{base}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
