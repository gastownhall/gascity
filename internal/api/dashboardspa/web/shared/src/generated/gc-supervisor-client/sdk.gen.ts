...
/**
 * Delete v0 city by city name worker claim
 */
export const deleteV0CityByCityNameWorkerClaim = <ThrowOnError extends boolean = false>(options: Options<DeleteV0CityByCityNameWorkerClaimData, ThrowOnError>) => (options.client ?? client).delete<DeleteV0CityByCityNameWorkerClaimResponses, DeleteV0CityByCityNameWorkerClaimErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name worker claim
 */
export const postV0CityByCityNameWorkerClaim = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameWorkerClaimData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameWorkerClaimResponses, PostV0CityByCityNameWorkerClaimErrors, ThrowOnError>({
    url: '/v0/city/{cityName}/worker/claim',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Post v0 city by city name worker close
 */
export const postV0CityByCityNameWorkerClose = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameWorkerCloseData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameWorkerCloseResponses, PostV0CityByCityNameWorkerCloseErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name worker heartbeat
 */
export const postV0CityByCityNameWorkerHeartbeat = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameWorkerHeartbeatData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameWorkerHeartbeatResponses, PostV0CityByCityNameWorkerHeartbeatErrors, ThrowOnError>({
