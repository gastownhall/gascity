...
var bootstrapPolicy = Ledger{
	...
	Medium: []MediumOwner{
		...
		},
		{
			PackageDir:      "cmd/gc",
			PackageName:     "main",
			Owner:           "TestDoltStateHandoffInspectAndStopOwnedProcess",
			Resources:       []Resource{ResourceSubprocess, ResourceFixedSleep},
			OwnerBead:       "ga-p9iuv.30.1.1.5",
			Invariant:       "managed Dolt ownership handoff subprocess and lifecycle timing proof is a checked Medium owner",
			ResourceOwner:   "the fixture subprocess and bounded lifecycle sleeps are confined to TestDoltStateHandoffInspectAndStopOwnedProcess",
			MigrationTarget: "P0.4b",
			Expires:         "2026-10-01",
		},
	},
