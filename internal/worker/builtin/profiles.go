		...
		OptionsSchema: []BuiltinProviderOption{
			{
				...
				Choices: []BuiltinOptionChoice{
					{Value: "", Label: "Default"},
					// Anthropic direct
					{Value: "anthropic/claude-sonnet-4.6", Label: "Claude Sonnet 4.6", FlagArgs: []string{"--model", "anthropic/claude-sonnet-4.6"}},
					{Value: "anthropic/claude-opus-4.7", Label: "Claude Opus 4.7", FlagArgs: []string{"--model", "anthropic/claude-opus-4.7"}},
					// OpenRouter top models (based on openrouter.ai/rankings)
					{Value: "openrouter/moonshotai/kimi-k2.6", Label: "Kimi K2.6 (OpenRouter)", FlagArgs: []string{"--model", "openrouter/moonshotai/kimi-k2.6"}},
					{Value: "openrouter/anthropic/claude-sonnet-4.6", Label: "Claude Sonnet 4.6 (OpenRouter)", FlagArgs: []string{"--model", "openrouter/anthropic/claude-sonnet-4.6"}},
					{Value: "openrouter/deepseek/deepseek-v3.2", Label: "DeepSeek V3.2 (OpenRouter)", FlagArgs: []string{"--model", "openrouter/deepseek/deepseek-v3.2"}},
					{Value: "openrouter/anthropic/claude-opus-4.7", Label: "Claude Opus 4.7 (OpenRouter)", FlagArgs: []string{"--model", "openrouter/anthropic/claude-opus-4.7"}},
					{Value: "openrouter/google/gemini-3-flash-preview", Label: "Gemini 3 Flash Preview (OpenRouter)", FlagArgs: []string{"--model", "openrouter/google/gemini-3-flash-preview"}},
					{Value: "openrouter/x-ai/grok-4.1-fast", Label: "Grok 4.1 Fast (OpenRouter)", FlagArgs: []string{"--model", "openrouter/x-ai/grok-4.1-fast"}},
				},
			},
		},
	},
