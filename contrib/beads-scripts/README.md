...
| `GC_K8S_DOLT_HOST` | `dolt.gc.svc.cluster.local` | Deprecated Dolt service DNS compatibility input |
| `GC_K8S_DOLT_PORT` | `3307` | Deprecated Dolt service port compatibility input |
