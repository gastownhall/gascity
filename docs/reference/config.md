...
| `supports_wait_idle_nudge` | boolean |  |  | SupportsWaitIdleNudge indicates wait-idle nudges may be delivered by waiting for a prompt boundary and then injecting a wrapped reminder. |
