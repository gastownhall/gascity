...
| `session-lifecycle-domain-cleanup-plan` | Active implementation plan | Red-green-refactor plan for centralizing session lifecycle projection and transition writes behind typed abstractions |
